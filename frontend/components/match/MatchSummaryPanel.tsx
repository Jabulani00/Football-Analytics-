...
import MatchPredictionsPanel from '@/components/match/MatchPredictionsPanel';
...
export default function MatchSummaryPanel({ fixture, fixtureId }: MatchSummaryPanelProps) {
  ...
  return (
    <View style={styles.wrap}>
      ...
      />
      <SimilarMatches fixtureId={fixtureId} />
